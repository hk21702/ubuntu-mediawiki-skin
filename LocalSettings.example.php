...
# When enabled, the skin loads the cookie-policy library which sets
# Google Consent Mode v2 defaults to "denied" before GTM initialises.
# The vendor and consent modules are loaded automatically by the skin's
# ResourceLoader modules (declared in skin.json scripts/styles arrays).
...
# Uses the js-revoke-cookie-manager class that the cookie-policy library
# listens for natively.
...
# The cookie-policy vendor IIFE is loaded by the skin's ResourceLoader modules
# (skins.ubuntu.cookieConsent.vendor). Its addGoogleConsentMode() sets
